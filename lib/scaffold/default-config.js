...
/**
 * Will return the path and default bitcore-node-seci configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-seci.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, defaultPath, './data/secid')
          }
        }
      }
    };
